...
3. RENAME main folder, using the same project name (very important in Android deploy)
        example
...
Remember that an about dialog is mandatory en open source licensing. Included QtLegal is a good example
